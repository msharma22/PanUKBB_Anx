#!/bin/bash
##############################################################Anxious/Worrier Feelings Phenotype (1980) -- META ##########################################################################
...
--gwas_file /home/maya/prediXcan/harmonizedGWAS/Anx/hg38_PUKBB_META_Anx.tsv.gz \
...
--throw \
--output_file /home/maya/prediXcan/prediXcanOUTPUT/ANX/META/META_Anx_Amygdala.csv

#### META - Anterior Cingulate Cortex ### 
echo '#2'
/usr/bin/python $METAXCAN/SPrediXcan.py \
--gwas_file /home/maya/prediXcan/harmonizedGWAS/Anx/hg38_PUKBB_META_Anx.tsv.gz \
--snp_column panel_variant_id \
...
--model_db_snp_key varID \
--throw \
--output_file /home/maya/prediXcan/prediXcanOUTPUT/ANX/META/META_Anx_Anterior_Cingulate_Cortex.csv

### META - Caudate Basal Ganglia ### 
echo '#3'
/usr/bin/python $METAXCAN/SPrediXcan.py \
--gwas_file /home/maya/prediXcan/harmonizedGWAS/Anx/hg38_PUKBB_META_Anx.tsv.gz \
--snp_column panel_variant_id \
...
--model_db_snp_key varID \
--throw \
--output_file /home/maya/prediXcan/prediXcanOUTPUT/ANX/META/META_Anx_Caudate_Basal_Ganglia.csv

#### META - Cerebellar Hemisphere ### 
echo '#4'
/usr/bin/python $METAXCAN/SPrediXcan.py \
--gwas_file /home/maya/prediXcan/harmonizedGWAS/Anx/hg38_PUKBB_META_Anx.tsv.gz \
--snp_column panel_variant_id \
...
--model_db_snp_key varID \
--throw \
--output_file /home/maya/prediXcan/prediXcanOUTPUT/ANX/META/META_Anx_Cerebellar_Hemisphere.csv
...
--model_db_snp_key varID \
--throw \
--output_file /home/maya/prediXcan/prediXcanOUTPUT/ANX/META/META_Anx_Cerebellum.csv
...
--model_db_snp_key varID \
--throw \
--output_file /home/maya/prediXcan/prediXcanOUTPUT/ANX/META/META_Cortex.csv
...
--model_db_snp_key varID \
--throw \
--output_file /home/maya/prediXcan/prediXcanOUTPUT/ANX/META/META_Frontal_Cortex.csv
...
--model_db_snp_key varID \
--throw \
--output_file /home/maya/prediXcan/prediXcanOUTPUT/ANX/META/META_Anx_Hippocampus.csv
...
--model_db_snp_key varID \
--throw \
--output_file /home/maya/prediXcan/prediXcanOUTPUT/ANX/META/META_Anx_Hypothalamus.csv


# #### META - Nucleus Accumbens Basal Ganglia ### 
echo '#10'
/usr/bin/python $METAXCAN/SPrediXcan.py \
--gwas_file /home/maya/prediXcan/harmonizedGWAS/Anx/hg38_PUKBB_META_Anx.tsv.gz \
--snp_column panel_variant_id \
...
--model_db_snp_key varID \
--throw \
--output_file /home/maya/prediXcan/prediXcanOUTPUT/ANX/META/META_Anx_Nucleus_Accumbens_Basal_Ganglia.csv

# #### META - Putamen Basal Ganglia ### 
echo '#11'
/usr/bin/python $METAXCAN/SPrediXcan.py \
--gwas_file /home/maya/prediXcan/harmonizedGWAS/Anx/hg38_PUKBB_META_Anx.tsv.gz \
--snp_column panel_variant_id \
...
--model_db_snp_key varID \
--throw \
--output_file /home/maya/prediXcan/prediXcanOUTPUT/ANX/META/META_Anx_Putamen_Basal_Ganglia.csv

#### META - Spinal Cord Cervical C-1 ### 
echo '#12'
/usr/bin/python $METAXCAN/SPrediXcan.py \
--gwas_file /home/maya/prediXcan/harmonizedGWAS/Anx/hg38_PUKBB_META_Anx.tsv.gz \
--snp_column panel_variant_id \
...
--model_db_snp_key varID \
--throw \
--output_file /home/maya/prediXcan/prediXcanOUTPUT/ANX/META/META_Anx_Spinal_Cord_Cervical_c-1.csv

#### META - Substantia Nigra ### 
echo '#13'
/usr/bin/python $METAXCAN/SPrediXcan.py \
--gwas_file /home/maya/prediXcan/harmonizedGWAS/Anx/hg38_PUKBB_META_Anx.tsv.gz \
--snp_column panel_variant_id \
...
--model_db_snp_key varID \
--throw \
--output_file /home/maya/prediXcan/prediXcanOUTPUT/ANX/META/META_Anx_Substantia_nigra.csv
