...
GWASdir = "/home/maya/panUKBB-COLOC/gwasFILES/AFR_Anx_coloc"
eQTLdir = "/home/maya/panUKBB-COLOC/eQTL_data/Cerebellar_Hemisphere/AFR_Anx_colocs/CTAGE5_data.csv"
...
first <- c(38765284)
last <- c(39888513)
id <- c('ENSG00000150527.16')

##chr14:39267414-39350694 (UCSC)
###chr14:39265284-39388513:+ (Gtex)
## Use: 39267414 (-500K) - 39388513 (+500K) == 38765284-39888513
...
gwascolocsusie = list("beta" = susiesnps$BETA.y, "varbeta" = (susiesnps$SE.y)^2, "snp" = susiesnps$V2, "position" = susiesnps$POS,
                      "type" = "cc", "LD"=R, "N" = 90) #need to add N, check ref later
